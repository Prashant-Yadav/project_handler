...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browsersupport: '1',
  appsig: 'S20141396441215z',
  subscribe: '',
  subscribe2: '',
  branduid: '18d02d6b198d8458ae7faf0f186e73a0|1396356710',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://localhost/projecthandler/registration.html',
  page_url: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '14.139.240.226'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 14.139.240.226 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://localhost/projecthandler/registration.html'; */
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('c1p720pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg c1p720_3, c1p720_4, ... c1p720_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'c1p720';
     span.id = 'c1p720' + "_" + properties.spancount;
     span.name='c1p720' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'c1p720spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickc1p720,   false);
  addEvent(adpop_span, "click", doMouseClickc1p720);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'c1p720frame';
  gframe.name = 'c1p720frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('c1p720frame');
 ...
 function setupc1p720CSS()
 {
  writeLog(1, 'setupc1p720CSS()');
  ...
  // style.innerHTML = '.c1p720 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.c1p720 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.c1p720 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.c1p720 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.c1p720 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
